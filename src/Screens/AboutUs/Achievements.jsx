...
import { HeadLine, Heading, DividerStyled, MainImage, ImageGrid } from "./styles";
...
function Achievements() {
    return (
        <>
            ...
            <MainImage src={Growth} style={{ marginTop: '20px', position: 'relative' }} />
            <ImageGrid container spacing={2}>
                <Grid item sm={4} xs={12}>
                    <BlueCardAchievement name="16.74M sft."
                        description="committed for 1st WELL Portfolio from India" />
                </Grid>
                <Grid item sm={4} xs={12}>
                    <BlueCardAchievement name="$150M"
                        description="of IT Park space bought in Gurugram" />
                </Grid>
                <Grid item sm={4} xs={12}>
                    <BlueCardAchievement name="$1B"
