...
import { HeadLine, Heading, SubHeading, DividerStyled, TabsBox, CapTabContent } from "./styles";
                ...
                <Box sx={{ py: 3 }}>
                    <CapTabContent>
                        ...
                        <Typography className="last-text">
                            We oversee daily operations and maintenance of a diverse portfolio,
                            comprising commercial, retail, residential, and mixed-use properties
                    ...
                    <CapTabContent>
                        ...
                        <Typography className="last-text">
                            From Class-A commercial office space to luxury apartments, our team
                            is dedicated to achieving leasing success in a competitive marketplace.
                        </Typography>
                    </CapTabContent>
                    <CapTabContent>
                        <div className="starting">
                        ...
                        <Typography className="last-text">
                            Through market research, in-house expertise and a hands-on approach,
                            we establish effective campaigns and programs highlighting the vision,
                            identity, position and brand for each project.
                        </Typography>
                    </CapTabContent>
                </Box>
            )}
