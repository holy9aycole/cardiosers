        ...
        {accordionArray.map((item, index) => (
          <AccordionContainer key={index}>
            <StyledAccordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
              ...
              <StyledAccordionDetails>
                <StyledCard2>
                  <CardMedia component="img" alt="banner1" height={200} image={`http://52.172.227.233${item.About.image.url}`} />
                  <StyledCardContent>
              ...
              <StyledAccordionDetails2>
                {[...Array(5)].map((e) => (
                  <div key={e} style={{ marginLeft: '15px', marginBottom: '10px' }}>
                    <Player src="https://media.w3.org/2010/05/sintel/trailer_hd.mp4" width={320} height={170} fluid={false} style={{ marginRight: '10px' }} />
                  </div>
                ))}
              </StyledAccordionDetails2>
            </StyledAccordion>
            ...
            <StyledAccordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
              ...
              <StyledAccordionDetails2>
                {[...Array(5)].map((e) => (
                  <div key={e} style={{ marginLeft: '15px', marginBottom: '10px' }}>
                    <Player src="http://www.w3schools.com/html/mov_bbb.mp4" width={320} height={170} fluid={false} style={{ marginRight: '10px' }} />
                  </div>
                ))}
              </StyledAccordionDetails2>
            </StyledAccordion>
              ...
              <StyledAccordionDetails>
                <ImageContainer>
                  {item.Gallery.map((item, index) => (
                    <>
                      <ModelImage src={`${process.env.REACT_APP_BACKEND_URL}${item.url}`} alt="" loading="lazy" key={index} onClick={() => handleOpen(item.url)} />
                    </>
                  ))}
                </ImageContainer>
              </StyledAccordionDetails>
                ...
                {item.FloorPlan.map((list) => (
                  <StyledCard key={list}>
                    ...
                    <FloorPlans>
                      ...
                      <PDFDownload src={pdf} onClick={() => handleDownload(list.url, list.name)} />
                    </FloorPlans>
                  </StyledCard>
                ))}
              </StyledAccordionDetails2>
