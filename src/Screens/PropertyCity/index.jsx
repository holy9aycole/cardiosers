        ...
        {accordionArray.map((item, index) => (
          <AccordionContainer key={index}>
              ...
              <StyledAccordionDetails>
                <StyledCard2>
                  <CardMedia
                    ...
                    alt="banner1"
                    height={200}
                    image={`${process.env.REACT_APP_BACKEND_URL}${item?.About?.image?.url}`}
                  />
                  <StyledCardContent>
            ...
            >
              ...
              <StyledAccordionDetails2>
                {item.MicroMarketVideo.map((item, index) => (
                  <div
                    key={index}
                    style={{ marginLeft: "15px", marginBottom: "10px" }}
                  >
                    <ReactPlayer
                      url={`${process.env.REACT_APP_BACKEND_URL}${item?.url}`}
                      download
                      controls
            ...
            >
              ...
              <StyledAccordionDetails2>
                {item.ProgressVideo.map((item, index) => (
                  <div
                    key={index}
                    style={{ marginLeft: "15px", marginBottom: "10px" }}
                  >
